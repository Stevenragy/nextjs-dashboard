                                ...
                                <div className="flex items-center justify-between border-b pb-4">
                                    <div>
                                        <div className="mb-2 flex items-center">
                                            <Image src={invoice.image_url} className="mr-2 rounded-full" width={28} height={28} alt="invoice" />
                                            <p>{invoice.name}</p>
                                        </div>
                                ...
                                <tr
                                    ...
                                    <td className="whitespace-nowrap py-3 pl-6 pr-3">
                                        <div className="flex items-center gap-3">
                                            <Image alt="table" src={invoice.image_url} className="rounded-full" width={28} height={28} />
                                            <p>{invoice.name}</p>
                                        </div>
                                    </td>
